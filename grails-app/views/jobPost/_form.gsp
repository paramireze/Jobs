...
<div class="form-group fieldcontain ${hasErrors(bean: jobPostInstance, field: 'salaryRange', 'error')} ">
    ...
    <g:textField class="form-control" name="salaryRange" value="${jobPostInstance?.salaryRange}"/>
...
<div class="form-group fieldcontain ${hasErrors(bean: jobPostInstance, field: 'previousJobPost', 'error')} ">
    ...
    <g:select id="previousJobPost" name="previousJobPost.id" from="${jobs.JobPost.list()}" optionKey="id"
              value="${jobPostInstance?.previousJobPost?.id}" class="many-to-one form-control" noSelection="['null': '']"/>
...
<div class="form-group fieldcontain ${hasErrors(bean: jobPostInstance, field: 'application', 'error')} ">
    ...
    <g:select id="application" name="application.id" from="${jobs.Application.list()}" optionKey="id"
              value="${jobPostInstance?.application?.id}" class="many-to-one form-control" noSelection="['null': '']"/>
...
<div class="form-group fieldcontain ${hasErrors(bean: jobPostInstance, field: 'active', 'error')} ">
    ...
    <g:checkBox class="form-control" name="active" value="${jobPostInstance?.active}"/>
...
<div class="form-group fieldcontain ${hasErrors(bean: jobPostInstance, field: 'employmentType', 'error')} required">
    ...
    <g:select id="employmentType" name="employmentType.id" from="${jobs.EmploymentType.list()}" optionKey="id"
              required="" value="${jobPostInstance?.employmentType?.id}" class="many-to-one form-control"/>
...
<div class="form-group fieldcontain ${hasErrors(bean: jobPostInstance, field: 'job', 'error')} required">
    ...
    <g:select id="job" name="job.id" from="${jobs.Job.list()}" optionKey="id" required=""
              value="${jobPostInstance?.job?.id}" class="many-to-one form-control"/>
...
<div class="form-group fieldcontain ${hasErrors(bean: jobPostInstance, field: 'postEnd', 'error')} required">
    ...
    <g:textField name="postEnd" class="form-control" required="" value="${jobPostInstance?.postEnd}"/>
...
<div class="form-group fieldcontain ${hasErrors(bean: jobPostInstance, field: 'postStart', 'error')} required">
    ...
    <g:textField class="form-control" name="postStart" required="" value="${jobPostInstance?.postStart}"/>
</div>
